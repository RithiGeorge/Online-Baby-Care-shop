...
<html>
<head>
<title>Free Flat Clean HTML5 Calendar Widget | Designmaz</title>
<!--Custom Theme files-->
...
<!--//web-fonts-->
<!--Calender-->
<script src="calender/js/jquery-1.11.1.min.js"></script>
...
<body>
	<!--main-->
	<div class="main">	
		<h1>Free Flat Clean HTML5 Calendar Widget</h1>
		<div class="calnder">
			<div class="column_right_grid calender">
				...
				<!-- pop-up-box -->
				<script type="text/javascript" src="calender/js/modernizr.custom.min.js"></script>    
				<link href="calender/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
				<script src="calender/js/jquery.magnific-popup.js" type="text/javascript"></script>
				<!-- //pop-up-box -->
	...
	<div class="copy-right">
		<p>HTML Template by <a href="https://www.designmaz.net">Designmaz</a></p>
	</div>
	<!--//main-->
</body>
</html>