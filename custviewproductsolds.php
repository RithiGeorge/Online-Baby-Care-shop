...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="cart/css/font-awesome.css" type="text/css" media="all">
	<!-- //Font-Awesome-File-Links -->
</head>
<!-- //Head -->
<!-- Body -->
...
<body>
			...
			<div class="container">
				<div class="top-grid">
					<div class="cart-grid" id="cart-1">
						<div class="img">
							<img src="cart/images/d5.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$60.00</li>
					...
					<div class="cart-grid" id="cart-2">
						<div class="img">
							<img src="cart/images/d1.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
					...
					<div class="cart-grid" id="cart-3">
						<div class="img">
							<img src="cart/images/d8.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$40.00</li>
					...
					<div class="cart-grid" id="cart-4">
						<div class="img">
							<img src="cart/images/d4.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
							<li class="right-text">$195.00</li>
				...
				<div class="bot-grid">
					<div class="cart-grid" id="cart-5">
						<div class="img">
							<img src="cart/images/d7.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$20.00</li>
					...
					<div class="cart-grid" id="cart-6">
						<div class="img">
							<img src="cart/images/d3.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$50.00</li>
							<li class="right-text">$95.00</li>
					...
					<div class="cart-grid" id="cart-7">
						<div class="img">
							<img src="cart/images/d2.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$25.00</li>
					...
					<div class="cart-grid" id="cart-8">
						<div class="img">
							<img src="cart/images/d6.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$36.00</li>
	...
	<!-- Default-JavaScript -->
	<script src="cart/js/jquery-2.2.3.js"></script>
	<!-- Custom-JavaScript-File-Links -->

	<!-- cart-js -->
	<script src="cart/js/minicart.min.js"></script>
	<script>
		// Mini Cart
